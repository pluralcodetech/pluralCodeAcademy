...
import webDigitalListAction from 'src/Redux Statement/actions/webDigitalListAction';

const WebDigitalList = () => {
    const webDigitalListContent = useSelector(state => state.webDigitalListData.webDigitalList);
    
    const dispatch = useDispatch();

    useEffect(() => {
        dispatch(webDigitalListAction());
    }, [dispatch]);
